...
import pytest
from src.data.validator import FineGrainedValidator, ValidationResult
...
class TestValidatorEdges:
    ...
    def test_partial_garbage_data(self, validator):
        ...
        assert any("Invalid price" in issue for issue in result.issues) or \
               any("Missing price" in issue for issue in result.issues)
